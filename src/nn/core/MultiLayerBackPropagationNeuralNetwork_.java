...
public class MultiLayerBackPropagationNeuralNetwork_ extends BackPropagationNeuralNetwork {
	 ...
	 */
	public MultiLayerBackPropagationNeuralNetwork_(InputUnit[] inputs, SigmoidNeuronUnit[] outputs, int[] hidden, double alpha, double threshold, int epochs, int fold) {
	...
	public static double[] crossValidation(MultiLayerBackPropagationNeuralNetwork_ nn, int k, ArrayList<Example> examples) {
	...
	static public void main(String[] args) {
		...
		MultiLayerBackPropagationNeuralNetwork_ nn = new MultiLayerBackPropagationNeuralNetwork_(in, out, hidden, alpha, stop, epoch, k);
